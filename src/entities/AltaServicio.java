...
public class AltaServicio {
    ...
    /**
     * @return the limpiezaVidrio
     */
    public static int getLimpiezaVidrio() {
        return limpiezaVidrio;
    }

    /**
     * @param aLimpiezaVidrio the limpiezaVidrio to set
     */
    public static void setLimpiezaVidrio(int aLimpiezaVidrio) {
        limpiezaVidrio = aLimpiezaVidrio;
    }
    ...
    private static int limpiezaVidrio = 0;
